...
│   │   └── 2024_01_01_000002_create_admin_settings_table.php
│   └── seeders/
│       ├── DatabaseSeeder.php
...
```
┌─────────────────────────────────────────────────────────────┐
│  🏠 HOME  │  🛒 PRODUK  │  ⭐ TESTIMONI  │  📞 KONTAK      │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  ┌─────────────────────┐    ┌─────────────────────────┐    │
│  │                     │    │                         │    │
│  │   SOLUSI            │    │    [Gambar Sepeda]      │    │
│  │   TRANSPORTASI      │    │                         │    │
│  │   MODERN            │    │                         │    │
│  │                     │    │                         │    │
│  │   [Lihat Produk]    │    │                         │    │
...
│                                                             │
│  ─────────────── Stats ───────────────                      │
│  10+ │ 3 Toko │ 100% Service │ 24/7                         │
│                                                             │
│  ─────────────── Produk ───────────────                    │
│  ┌────────┐ ┌────────┐ ┌────────┐                          │
│  │Produk 1│ │Produk 2│ │Produk 3│                          │
│  │ Rp 3jt │ │ Rp 4jt │ │ Rp 5jt │                          │
│  └────────┘ └────────┘ └────────┘                          │
│                                                             │
│  ─────────────── Testimoni ───────────────                  │
│  ┌─────────────────────────────────────────────┐           │
...
│                                                             │
│  ─────────────── Kontak ───────────────                    │
│  📍 Bondowoso │ 📞 +62 852 │ 💬 WhatsApp │ 🛒 Shopee     │
│  🗺️ [Google Maps Embed]                                   │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
