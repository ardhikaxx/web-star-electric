        ...
        <div class="page-content">
            ...
            <div class="form-card">
                <div class="form-card-header">
                    <h3><i class="fa-solid fa-box me-2"></i>Form Tambah Produk</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4 mb-4">
                                ...
                                <div class="image-upload-area" id="imageUploadArea">
                                    ...
                                    <span class="browse-text">Pilih File</span>
                                </div>
                                <input type="file" name="image" id="imageInput" class="image-input" accept="image/jpeg,image/png,image/webp">
                                @error('image')
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="form-hint">Harga asli sebelum diskon (akan ditampilkan dengan garis coret)</p>
                                    @error('old_price')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        imageUploadArea.addEventListener('dragover', function(e) {
            ...
            imageUploadArea.style.background = 'rgba(230, 32, 38, 0.05)';
        });
        ...
        function handleImagePreview(file) {
            if (file.type.match('image.*')) {
                ...
                reader.onload = function(e) {
                    imageUploadArea.innerHTML = `<img src="${e.target.result}" class="image-preview" alt="Preview">`;
