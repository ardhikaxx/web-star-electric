...
@section('content')
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 20px;">
        <div class="card-header bg-white py-3" style="border-radius: 20px 20px 0 0;">
            <h5 class="mb-0 fw-bold"><i class="fa-solid fa-user-gear me-2 text-primary"></i>Pengaturan Profile Admin</h5>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                // If any PIN field is partially filled, or if new pin is provided but current pin is missing
