...
<style>
    .welcome-banner {
        background: linear-gradient(135deg, var(--primary) 0%, #c41c1c 100%);
        border-radius: 16px;
        padding: 2rem;
        margin-bottom: 2rem;
        color: #fff;
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    <div class="info-card h-100">
                        ...
                        <div class="info-card-body">
                            <div class="info-item">
                                <div class="info-icon" style="background: rgba(230, 32, 38, 0.1);">
                                    <i class="fa-solid fa-plus"></i>
                                </div>
                                <div class="info-content">
                            ...
                            <div class="info-item">
                                <div class="info-icon" style="background: rgba(40, 167, 69, 0.1); color: var(--success);">
                                    <i class="fa-solid fa-list"></i>
                                </div>
                                <div class="info-content">
                                    <h4>Kelola Produk</h4>
                                    <p><a href="{{ route('admin.products.index') }}" class="text-decoration-none" style="color: var(--primary);">Klik di sini</a> untuk melihat dan mengelola semua produk.</p>
                                </div>
                            </div>
                            <div class="info-item">
                                <div class="info-icon" style="background: rgba(255, 193, 7, 0.1); color: #ffc107;">
                                    <i class="fa-solid fa-globe"></i>
                                </div>
                                <div class="info-content">
                                    <h4>Landing Page</h4>
                                    <p><a href="{{ url('/') }}" target="_blank" class="text-decoration-none" style="color: var(--primary);">Klik di sini</a> untuk melihat tampilan website publik.</p>
                                </div>
                            </div>
                        </div>
                    </div>
